 ...
 * @author Naohisa Minagawa <info@vizualizer.jp>
 */
class VizualizerTrade_Module_Bill_Pdf_Quotation extends Vizualizer_Plugin_Module_Pdf
{
    ...
    function execute($params)
    {
        ...
        foreach($billIds as $billId){
            ...
            // 作成日を描画
            $this->text(450, 68, 9, "お見積作成日：".date("Y年m月d日", strtotime($bill->planed_date)), true);
            ...
            // 合計金額を描画
            $this->text(35, 230, 20, "お見積金額： ￥".number_format($bill->total)."-", true);
